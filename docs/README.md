...
| `CR-129` | Implemented behind localhost preview | Extend the P1 memory sweep by five yards to 40 yards, darken its blue Starsplinter wedge, add a slim raised laser core, remove each rune as the sweep resolves it, and clamp roaming NPC targets inside the playable P1 arena. Tracked from [`INBOX-20260727-214658-47c3b4`](../inbox/INBOX-20260727-214658-47c3b4.md). |
