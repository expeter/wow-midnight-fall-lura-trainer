...
describe('Intermission game rules', () => {
  ...
  it('allows final Intermission recovery without enabling pickup during Phase 1 mechanics', () => {
    expect(canPickupCrystalDuringEvent('p1-crystals')).toBe(false)
