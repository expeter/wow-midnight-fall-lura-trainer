...
import { bossDamageScoreBonus, isInsideP3Pool, p4BossHealthWithPlayerDamage, p4FrontSoakerPosition, p4PlayerSplinterHitsNpc, p4RenderedNpcSplinterHitsPlayer, p4RenderedNpcSplinterOrigin, p4StartingBossState, p4TankKillsBox, preP4BossHealth, shouldTriggerP3EarlyClear, starsplinterHitsCrystalCarrier } from './game'
    ...
    if (event.startsWith('p4-')) {
      ...
      if (event === 'p4-cycle') {
        ...
        if (p4SplinterResolutionActive(age) && p4SplinterCheckedRef.current !== checkId) {
          ...
          if (p4PlayerSplinterHitsNpc(renderedNpcPositionsRef.current, position, rotation)) { triggerWipe('Your Phase 4 Starsplinter hit another player'); return }
        ...
        for (let ordinal = 0; ordinal < 3; ordinal += 1) {
          ...
          if (p4RenderedNpcSplinterHitsPlayer(renderedNpcPositionsRef.current, ordinal, fallbackOrigin, rotation, position)) {
