...
| `CR-140` | Implemented behind localhost preview | Slowed the P1 interrupt orbs and gave all three their own cones that rotate with them. NPCs interrupt deterministically between 0.5–1.0 seconds, removing their cast bar/orbs/cones immediately; the controlled player's green kick window lasts 1.7 seconds, followed by a 0.3-second lethal completion delay. |
