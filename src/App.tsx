...
export default function App() {
  ...
  if (screen === 'menu') return <main className="shell setup-shell" id="setup-top">
    ...
    <div className="setup-overview"><AchievementBadgeSummary collection={achievementCollection} /><OnlineStandingSummary session={onlineSession} onManage={() => setSetupTab('profile')} /></div>
