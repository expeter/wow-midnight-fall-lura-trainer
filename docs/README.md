...
| `CR-104` | Implemented behind localhost preview | Launch each P1 Heaven Glaive from the outside boss at three times configured player speed, decelerate it over time, ricochet it from both the outer wall and middle bubble, and retain it for 60 seconds without generating a new set during the rotating-beam mechanic. |
