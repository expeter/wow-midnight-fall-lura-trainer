...
export default function App() {
  ...
  const [setupTab, setSetupTab] = useState<'practice' | 'raidplan' | 'online'>(() => window.location.hash.startsWith('#raidplan=') ? 'raidplan' : 'practice')
  ...
  if (screen === 'menu') return <main className="shell setup-shell" id="setup-top">
    ...
    <div className="setup-overview"><AchievementBadgeSummary collection={achievementCollection} /><OnlineStandingSummary session={onlineSession} onManage={() => setSetupTab('online')} /></div>
    ...
    <nav className="setup-tabs" aria-label="Setup sections">
      <button className={setupTab === 'practice' ? 'selected' : ''} aria-current={setupTab === 'practice' ? 'page' : undefined} onClick={() => setSetupTab('practice')}>Practice settings</button>
      ...
      <button className={setupTab === 'online' ? 'selected' : ''} aria-current={setupTab === 'online' ? 'page' : undefined} onClick={() => setSetupTab('online')}>Online profile &amp; leaderboard</button>
    </nav>
    <section className="setup-tab-panel" aria-label="Practice settings" hidden={setupTab !== 'practice'}>
    ...
    <section className="setup-tab-panel" aria-label="Online profile and leaderboard" hidden={setupTab !== 'online'}>
