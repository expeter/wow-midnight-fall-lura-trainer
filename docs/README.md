...
| `FR-060` | Planned | Decide whether the completed run in [`INBOX-20260729-185527-3c7431`](../inbox/INBOX-20260729-185527-3c7431.md) should be recovered into the public leaderboard after `BUG-111` prevented issuance of its required server-side attempt. Do not insert or relax verification without explicit confirmation. |
...
| `CR-163` | Planned | Repair the copied completion image layout shown in [`INBOX-20260729-185450-1391a7`](../inbox/INBOX-20260729-185450-1391a7.md): keep every phase card and the optional-challenge text inside the exported image instead of clipping or overflowing horizontally. Await explicit confirmation before implementation. |
