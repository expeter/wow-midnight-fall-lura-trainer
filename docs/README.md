...
| `BUG-063` | Implemented | Restore the Phase 4 “Left, Right, Left, Move” raidlead by preloading its clocked clips before Phase 4 and making prerecorded calls depend only on Web Audio—not on browser speech-synthesis support. |
