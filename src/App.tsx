...
export default function App() {
  ...
  if (screen === 'menu') return <main className="shell setup-shell">
    ...
    <div className="plan-heading raid-planning-heading"><p className="eyebrow">RAID PLANNING</p><h2>Layouts and sharing</h2><p className="hint">Load a guild layout, exchange a complete plan, or configure each phase below.</p></div>
