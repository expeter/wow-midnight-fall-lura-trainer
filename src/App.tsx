...
export default function App() {
  ...
  async function shareCompletionImage() {
    ...
    context.fillText(`${resultProfile.name} · ${resultClass} · ${difficulty.toUpperCase()} · ATTEMPT #${attemptNumber}`, 72, 211)
    context.fillStyle = '#f7f5ee'
  ...
  if (screen === 'menu') return <main className="shell setup-shell">
    <BuildIndicator />
    <aside className="recruitment-banner">Wir suchen deutschsprachige Spieler für Season 2. <a href="https://raider.io/guilds/eu/blackrock/IAsgardI" target="_blank" rel="noreferrer">I Asgard I auf Raider.IO</a></aside>
    <CreatorCard />
