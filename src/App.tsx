...
import { CRYSTAL_GROUND_EXPLOSION_SECONDS, groundCrystalHasExpired, isCommittedP3ProtectionCrystal } from './game'
...
export default function App() {
  ...
  useEffect(() => {
    if (!crystal || !groundCrystalHasExpired(crystalAge, crystalAgeRef.current)) return
