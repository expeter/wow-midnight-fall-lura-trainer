...
export default function App() {
  ...
  if (screen === 'menu') return <main className="shell setup-shell" id="setup-top">
    ...
    {setupTab === 'game' && <OnlinePanel compact view="leaderboard" difficulty={difficulty === 'hard' ? 'hard' : 'normal'} duty={entryCrystalAssignments.includes(assignment) ? 'crystal' : 'non-crystal'} onSession={setOnlineSession} onOpenLeaderboard={() => setSetupTab('leaderboard')} />}
    </section>
    ...
    {setupTab === 'leaderboard' && <OnlinePanel view="leaderboard" difficulty={difficulty === 'hard' ? 'hard' : 'normal'} duty={entryCrystalAssignments.includes(assignment) ? 'crystal' : 'non-crystal'} onSession={setOnlineSession} />}
    </section>
