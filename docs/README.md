...
| `CR-071` | In progress | Tune cosmetic attack motion by projectile family: arrows travel slowest, spell bolts fastest, remove bomb-like silhouettes, vary approach angles, and avoid a visually constant stacked stream in Phase 4. |
