...
export default function App() {
  ...
  const p4RenderedNpcPositionsRef = useRef<Point[]>([])
    ...
    if (event.startsWith('p4-')) {
      ...
      if (event === 'p4-cycle') {
        ...
        if (p4SplinterResolutionActive(age) && p4SplinterCheckedRef.current !== checkId) {
          ...
          if (p4PlayerSplinterHitsNpc(p4RenderedNpcPositionsRef.current, position, rotation)) { triggerWipe('Your Phase 4 Starsplinter hit another player'); return }
        ...
        for (let ordinal = 0; ordinal < 3; ordinal += 1) {
          ...
          const origin = p4RenderedNpcSplinterOrigin(p4RenderedNpcPositionsRef.current, ordinal, fallbackOrigin)
          destroyBoxesHitBySplinter(origin, rotation)
          if (p4RenderedNpcSplinterHitsPlayer(p4RenderedNpcPositionsRef.current, ordinal, fallbackOrigin, rotation, position)) {
    ...
    <div className="game-layout">
      ...
      >
        <GameScene
          ...
          onP4NpcPositions={props.onP4NpcPositions}
