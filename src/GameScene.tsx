...
interface SceneProps {
  ...
  onP4NpcPositions: (positions: Point[]) => void
  ...
  useEffect(() => {
    ...
    const render = () => {
      ...
      const npcPositions = npcs.map((sprite, index) => {
        ...
        if (p3PoolTarget && !p3RunePartnerApproach && !p3RunePairApproach) p3Target = keepP3NpcInSoak(p3Target, p3PoolTarget)
      ...
      if (phaseFour) state.onP4NpcPositions(npcPositions)
