...
describe('player menu', () => {
  ...
  it('shows and copies an offline Run-ID proof for result screenshots', async () => {
    ...
    await waitFor(() => expect(writeText).toHaveBeenCalledWith(expect.stringContaining('"checksumKey": "LURA-RESULT-V1"')))
    expect(writeText).toHaveBeenCalledWith(expect.stringContaining('"preview": true'))
  })
