...
describe('Intermission game rules', () => {
  ...
  it('adds five percent pre-Phase-4 health without changing the Phase 3 clear flow', () => {
    ...
    expect(shouldTriggerP3EarlyClear('p3-light-pools', 105)).toBe(true)
    expect(shouldTriggerP3EarlyClear('p3-archangel', 105)).toBe(true)
    expect(shouldTriggerP3EarlyClear('p3-light-pools', 104.5)).toBe(false)
    expect(shouldTriggerP3EarlyClear('p3-countdown', 105)).toBe(false)
    expect(shouldTriggerP3EarlyClear('p3-sector-move', 105)).toBe(false)
    expect(shouldTriggerP3EarlyClear('p4-cycle', 105)).toBe(false)
  })
